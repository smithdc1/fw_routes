# Generated by Django 6.0 on 2025-12-13 19:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gpx_file_url', models.URLField(max_length=500)),
                ...
                ('tags', models.ManyToManyField(blank=True, related_name='routes', to='routes.tag')),
            ],
            options={
